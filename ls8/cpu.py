...
class CPU:
    ...
    def handle_ALU(self,operand,ins):
        ...
        # print(ins,"instruction number")
        # print(alu_ops[ins][0],"OPS_CODE")
    ...
    def handle_OTHER(self,operand,ins):
        ...
        # print(operand,"operand")
        # print(ins,"instruction number")
        # print(other_ops[ins][0],"OPS_CODE")
...
###############################################################
    ...
    def JEQ(self,*args):
        register = self.reg[args[0]]
        print("fl", self.fl, "address", args[0])
    ...
    def JNE(self,*args):
        ...
        if self.fl != 0b00000001:
            self.pc = register
            print("jump",self.pc,"flag", self.fl)
        else:
            self.pc += 1
    def JGT(self,*args):
        pass
